...
function AerorouteChatShell({ aomiApiKey }: { aomiApiKey?: string }) {
  ...
  return (
    <div className="grid w-full min-w-0 grid-cols-1 gap-4 sm:gap-6 xl:grid-cols-[minmax(0,1fr)_minmax(0,360px)]">
      <div className="flex w-full min-w-0 min-h-[min(52vh,480px)] max-h-[min(82vh,calc(100dvh-10rem))] flex-col overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.035] backdrop-blur-xl sm:min-h-[min(64vh,640px)] sm:max-h-[min(75vh,calc(100svh-12rem))] lg:min-h-[min(70vh,720px)]">
